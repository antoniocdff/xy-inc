...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, '..', '..', '..', 'sistema-app', 'src'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
MEDIA_URL = '/media/'
STATIC_INTERMEDIARY = os.path.join(BASE_DIR, "..", "..", "..", "sistema-static")
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 50,
    'DEFAULT_FILTER_BACKENDS': ('sistema.rest.backends.TempBackend',),
